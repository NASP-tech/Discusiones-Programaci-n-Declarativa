...
%Ej.3 El enemigo de mi amigo es mi amigo
...
generar_numero_aleatorio(Min, Max) :-
    random_between(Min, Max, NumeroAleatorio),
    writeln("Número aleatorio generado: "),
    writeln(NumeroAleatorio).

generar_numero_aleatorio(1, 100).
